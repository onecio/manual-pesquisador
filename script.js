...
(function () {
  ...
  var SEARCH_INDEX = window.SEARCH_INDEX || [
    ...
    { title: 'Modelos editoriais', module: 'Referência', url: 'modelos-editoriais.html', keywords: 'modelo carta ao editor resposta a pareceres texto de submissão cover letter template editorial' },
    ...
    { title: 'Planejamento da Pesquisa', module: 'F4 · Planejamento', url: 'modulos/planejamento.html', keywords: 'planejamento problema pergunta picos objetivos preregistro critérios inclusão exclusão fluxo operacional template planejamento erros comuns protocolo coleta' },
    ...
    { title: 'Dados de Pesquisa', module: 'F11 · Execução', url: 'modulos/dados-pesquisa.html', keywords: 'dados de pesquisa coleta de dados dicionário de variáveis anonimização gestão de dados qualidade repositório preservação metadados depósito' },
    { title: 'Divulgação Científica', module: 'F15 · Impacto', url: 'modulos/divulgacao-cientifica.html', keywords: 'divulgação científica comunicação pública da ciência linguagem acessível alcance social cenários aplicados sensacionalismo responsabilidade pública públicos formato canal evidência' },
    { title: 'Ferramentas Digitais', module: 'F16 · Impacto', url: 'modulos/ferramentas-digitais.html', keywords: 'ferramentas digitais fluxo acadêmico gerenciador de referências automação organização de pesquisa fluxo operacional pilha mínima template backup versionamento erros comuns' },
    { title: 'IA na Pesquisa', module: 'F17 · Impacto', url: 'modulos/ia-pesquisa.html', keywords: 'ia na pesquisa inteligência artificial acadêmica uso responsável transparência supervisão humana alucinação limites de uso cenários aplicados governança comunicação responsável' },
    { title: 'Identidade do Pesquisador', module: 'F12 · Identidade', url: 'modulos/identidade-pesquisador.html', keywords: 'identidade do pesquisador trajetória acadêmica autoria presença científica reputação autoridade acadêmica perfis presença institucional' },
    { title: 'Financiamento', module: 'F13 · Identidade', url: 'modulos/financiamento.html', keywords: 'financiamento pesquisa edital agências de fomento proposta orçamento grant capes cnpq fap armadilhas leitura institucional' },
    { title: 'Bibliometria', module: 'F14 · Identidade', url: 'modulos/bibliometria.html', keywords: 'bibliometria citações indice h altmetria métricas acadêmicas impacto científico qualis capes leitura institucional brasil armadilhas' },

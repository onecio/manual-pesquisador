...
(function () {
  ...
  var SEARCH_INDEX = window.SEARCH_INDEX || [
    ...
    { title: 'Divulgação Científica', module: 'F15 · Impacto', url: 'modulos/divulgacao-cientifica.html', keywords: 'divulgação científica comunicação pública da ciência linguagem acessível alcance social cenários aplicados sensacionalismo responsabilidade pública' },
    ...
    { title: 'IA na Pesquisa', module: 'F17 · Impacto', url: 'modulos/ia-pesquisa.html', keywords: 'ia na pesquisa inteligência artificial acadêmica uso responsável transparência supervisão humana alucinação limites de uso cenários aplicados' },
